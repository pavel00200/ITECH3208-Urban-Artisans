...
export default function Shop() {
  ...
  if (loading) return <div className="pd">Loading products...</div>;
        ...
        <div className="shop-toolbar">
          <div className="toolbar-left">
            ...
            >
              ...
              <div className="dropdown-list">
                {categories.map((cat) => (
                  <button
                    key={cat}
                    className={`dropdown-item ${activeCat === cat ? "is-active" : ""}`}
                    onClick={() => {
                      setActiveCat(cat);
                      setShowFilter(false);
                    }}
            ...
            >
              ...
              <div className="dropdown-list">
                <button
                  className={`dropdown-item ${sort === "popular" ? "is-active" : ""}`}
                  onClick={() => {
                    setSort("popular");
                    setShowSort(false);
                  }}
                ...
                <button
                  className={`dropdown-item ${sort === "price-asc" ? "is-active" : ""}`}
                  onClick={() => {
                    setSort("price-asc");
                    setShowSort(false);
                  }}
                ...
                <button
                  className={`dropdown-item ${sort === "price-desc" ? "is-active" : ""}`}
                  onClick={() => {
                    setSort("price-desc");
                    setShowSort(false);
                  }}
                ...
                <button
                  className={`dropdown-item ${sort === "newest" ? "is-active" : ""}`}
                  onClick={() => {
                    setSort("newest");
                    setShowSort(false);
                  }}
